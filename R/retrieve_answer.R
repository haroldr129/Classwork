#' Funcion para que el usuario digite un numero entre 1 y 6 y le retorne la solucion de uno de los ejercicios propuestos en el Classwork 1
#' @param seleccionar es un numero
#' @return De acuerdo con la opcion seleccionada, el programa llevara al usuario al numero del ejercicio solucionado, mostrando al usuario un mensanje de la opcion seleccionada
#' en caso de que el numero no se encuentre dentro de los numeros del 1 al 6, arrojara un error
#' @examples
#' retrieve_answer(1)
#' retrieve_answer(2)
